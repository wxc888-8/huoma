            ...
            <div class="col-lg-12">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h6 class="modal-title" id="addChangeTitle">新增落地域名</h6>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <form name="add" action="ajax.php?act=addLandingDomain">
                ...
                <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="editChangeLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h6 class="modal-title" id="editChangeTitle">修改落地域名信息</h6>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <form name="edit" action="ajax.php?act=editLandingDomain">
    ...
    <script type="text/javascript">
        function initTable() {
            ...
            $('#listTable').bootstrapTable({
                ...
                url: 'ajax.php?act=landingDomainList',
                method: 'get',
                dataType: 'jsonp',
                uniqueId: 'id',
                selectItemName: 'ids[]',
        ...
        function setactive(id, state) {
            ...
            $.ajax({
                type: 'GET',
                url: 'ajax.php?act=setLandingDomainState&id=' + id + '&state=' + state,
                dataType: 'json',
                ...
                buttons: {
                    confirm: {
                        ...
                        action: function() {
                            ...
                            $.ajax({
                                url: "ajax.php?act=setLandingDomainStateAll",
                                type: "POST",
                                data: {
                                    "state": state,
                                    "str": postData
                ...
                buttons: {
                    confirm: {
                        ...
                        action: function() {
                            ...
                            $.ajax({
                                url: "ajax.php?act=delLandingDomainAll",
                                type: "POST",
                                data: {
                                    "str": postData
                                },
        ...
        $('#edit').on('show.bs.modal', function(event) {
            ...
            $.ajax({
                type: 'GET',
                url: 'ajax.php?act=getLandingDomainInfo&id=' + id,
                dataType: 'json',
                success: function(data) {
                    loader.destroy();
                    if (data.code == 0) {
                ...
                buttons: {
                    confirm: {
                        ...
                        action: function() {
                            ...
                            $.ajax({
                                url: "ajax.php?act=delLandingDomain",
                                type: "POST",
                                data: {
                                    "id": id
                                },
        ...
        function checkdomain(id, type) {
            ...
            $.ajax({
                type: 'GET',
                url: 'ajax.php?act=checkLandingDomain&id=' + id + '&type=' + type,
                dataType: 'json',
                success: function(data) {
                    loader.destroy();
                    if (data.code == 0) {
